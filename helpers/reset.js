const welcomeEmail = {
  generateEmail: function (email, resetcode) {
    return `
    <!DOCTYPE html>
                                      ...
                                      <tbody>
                                        <tr>
                                          <td valign="top" class="mcnTextContent" style="padding-top: 0; padding-right: 18px; padding-bottom: 9px; padding-left: 18px">
                                            <h2>
                                              <span style="font-size: 15px"><span style="font-family: comic sans ms, marker felt-thin, arial, sans-serif">Password Reset </span></span>
                                            </h2>
                                            Your password reset code is: ${resetcode}<br />
                                            <br />
                                            If you did not request to reset your password, please contact support here: &nbsp;
                                            <a href="mailto:gotta.application@gmail.com?subject = User Question&body = Message"> Send us an email </a>
                                            <br />
                                            <br />
                                            Have a great day!<br />
                                            <br />
                                  ...
                                  <td class="mcnCaptionBlockInner" valign="top" style="padding: 9px">
                                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnCaptionBottomContent" width="false">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td class="mcnTextContent" valign="top" style="padding: 0 9px 0 9px" width="563"></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
                                                                              ...
                                                                              <tbody>
                                                                                <tr>
                                                                                  <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                    <a href="http://www.facebook.com/gotta" target="_blank"
                                                                                      ><img
                                                                          ...
                                                                          >
                                                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                              <tbody>
                                                                                <tr>
                                                                                  <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                    <a href="http://www.twitter.com/gottaApp" target="_blank"
                                                                                      ><img
                                                                          ...
                                                                          >
                                                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                              <tbody>
                                                                                <tr>
                                                                                  <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                    <a href="http://www.instagram.com/gotta" target="_blank"
                                                                                      ><img
